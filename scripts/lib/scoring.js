...
// ---- ENHANCED BORDERLINE WITH HISTORICAL CONTEXT (GSD-inspired) ----
...
function getBorderlineContext(score, category, config) {
  try {
    ...
    // Find historical routing for this category
    ...
    // Get quality data if available (using shared TimestampMatcher)
    ...
    // Determine best historical model
...
module.exports = {
  ...
  getBorderlineContext: getBorderlineContext
};
